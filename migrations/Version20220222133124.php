 ...
 */
final class Version20220222133124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD portfolio_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE milestone CHANGE name_milstone name_milstone VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
