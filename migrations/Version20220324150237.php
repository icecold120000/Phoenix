 ...
 */
final class Version20220324150237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE team_child_id team_parent_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE team ADD CONSTRAINT FK_C4E0A61FC57FD497 FOREIGN KEY (team_parent_id) REFERENCES team (id)');
        $this->addSql('CREATE INDEX IDX_C4E0A61FC57FD497 ON team (team_parent_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team DROP FOREIGN KEY FK_C4E0A61FC57FD497');
        $this->addSql('DROP INDEX IDX_C4E0A61FC57FD497 ON team');
        $this->addSql('ALTER TABLE team CHANGE team_name team_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE team_parent_id team_child_id INT DEFAULT NULL');
