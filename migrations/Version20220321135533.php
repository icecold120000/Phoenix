 ...
 */
final class Version20220321135533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE status_id status_id INT NOT NULL');
    }
