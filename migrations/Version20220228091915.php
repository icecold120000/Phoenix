 ...
 */
final class Version20220228091915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE milestone CHANGE name_milstone name_milestone VARCHAR(255) NOT NULL, CHANGE value_milstone value_milestone INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE milestone ADD name_milstone VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP name_milestone, CHANGE value_milestone value_milstone INT NOT NULL');
