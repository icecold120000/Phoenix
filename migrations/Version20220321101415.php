 ...
 */
final class Version20220321101415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fact ADD is_validated TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE milestone ADD date_obtained DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fact DROP is_validated, CHANGE name_fact name_fact VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description_fact description_fact LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE milestone DROP date_obtained, CHANGE name_milestone name_milestone VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE portfolio CHANGE name_portfolio name_portfolio VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE project DROP updated_at, CHANGE name_project name_project VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description_project description_project LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE code_project code_project VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
