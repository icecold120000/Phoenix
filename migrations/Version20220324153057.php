 ...
 */
final class Version20220324153057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE ended_at ended_at DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE name_project name_project VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description_project description_project LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE ended_at ended_at DATE NOT NULL, CHANGE code_project code_project VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
